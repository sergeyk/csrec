...
    \begin{tabular}{|l|l|l|}
        \hline
        h \in \mathcal{H} & host, from a set of all users who have received at least $K$ couch requests                                    & ~ \\ \hline
        \mathcal{S}_h     & set of competitor sets $S$ for host $h$                                                                        & ~ \\ 
        S                 & competitor set for host $h$, composed of surfers who have made a couch request to $h$ at roughly the same time & ~ \\
        \hline
    \end{tabular}
\label{tab:notation}
\end{table}
